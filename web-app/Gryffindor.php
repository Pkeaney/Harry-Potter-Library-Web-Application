...
<div class="w3-container w3-padding-32" id="about">
    <h3 class="w3-border-bottom w3-border-light-grey w3-padding-16">Gryffindor</h3>
    <p>Gryffindor Library is one of the four main libraries in our Building.  It is the biggest sub section of the Library, with a coffee shop, Computer area, and a library section holding
    some of the books.
    </p>

    <img alt="Logo" src="img/Gryffindor.png"	class="w3-right" width="30%"	height="30%">
    <img alt="Logo" src="img/Gryffindor-pic.png"	class="w3-left" width="60%"	height="60%">
  </div>