...
<div class="w3-container w3-padding-32" id="Search">
    <h2 class="w3-border-bottom w3-border-light-grey w3-padding-16">My Account</h2>
     </div>

<div class="w3-container w3-padding-16" id="Details">
...
if ($queryResult == 1) {
    while ($row = mysqli_fetch_assoc($result)) {
        echo "<div class = 'account-details'>
                <h3>Name: " . $row['firstName'] . " " . $row['lastName'] . "</h4>
...
<h2>Loaned out Books:</h2>
<?php
$query = " SELECT books.isbnNumber, books.title, books.genre, books.author, books.loanedBy, users.userID, users.email
           FROM books
           INNER JOIN users ON books.loanedBy=users.userID
