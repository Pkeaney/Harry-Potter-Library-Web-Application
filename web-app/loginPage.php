...
<div class="w3-container w3-padding-32 w3-mobile" id="Login">
    <h2 class="w3-border-bottom w3-border-light-grey w3-padding-16">Login</h2>
...
<form action="loginserv.php" method="POST" style="text-align:center">
	...
	<input class="submit" type="submit" value="Login" id="submit_btn" name="submit">
	</form>
