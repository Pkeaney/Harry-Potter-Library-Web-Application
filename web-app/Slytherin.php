...
<h3 class="w3-border-bottom w3-border-light-grey w3-padding-16">Slytherin</h3>
<p>Slytherin Library is one of the four main libraries in our Building.  It is the smallest of the four main libraries with it being another book only floor, similar to Ravenclaw,
except just not as big.
</p>

<img alt="Logo" src="img/Slytherin.png"	class="w3-right" width="30%"	height="30%">
<img alt="Logo" src="img/Slytherin-pic.png"	class="w3-left" width="60%"	height="60%">
</div>